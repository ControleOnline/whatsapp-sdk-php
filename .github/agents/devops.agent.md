---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/whatsapp-sdk-php, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/whatsapp-sdk-php`.
...
- Checkout local: `api-community/modules/controleonline/whatsapp-sdk`
